...
class XSSTesterTab(QWidget):
    ...
    def init_ui(self):
        """Initialize the UI for the XSS Tester tab."""
        self.layout = QVBoxLayout()

        # Heading for the tab
        heading_label = QLabel("XSS Tester", self)
    ...
    def start_extraction(self):
        ...
        self.tester = XSSTester(target_url)
